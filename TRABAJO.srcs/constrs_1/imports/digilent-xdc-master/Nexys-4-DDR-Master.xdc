...
#create_clock -period 1000000000.000 -name CLK2 -waveform {0.000 500000000.000} -add [get_ports CLK2]
...
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { digsel[12] }]; #IO_L24P_T3_35 Sch=sw[12]
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { digsel[13] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
#set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { digsel[14] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { digsel[15] }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports SENSOR]
