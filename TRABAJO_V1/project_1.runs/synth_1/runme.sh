...
HD_PWD='C:/Users/yagob/Documents/GitHub/TRABAJO_VHDL/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_SEMAFORO3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_SEMAFORO3.tcl
